...
const icons = {
  ...
  voice: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
const menu = computed(() => [
  ...
  { name: 'VoiceConfig', title: '语音音色', icon: icons.voice },
